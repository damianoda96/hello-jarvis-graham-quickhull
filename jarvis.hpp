...
// 1 --> Clockwise
// 2 --> Counterclockwise
int j_orientation(Point p, Point q, Point r)
{
...
void j_convexHull(std::vector<Point> points, int n, std::string outputFile)
{
    ...
    do
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            // update q
            if (j_orientation(points[p], points[i], points[q]) == 2)
            q = i;
        }
